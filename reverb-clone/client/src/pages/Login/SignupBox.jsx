...
const SignupBox = ({ signupData, setSignupData, setShowSignupPassword, showSignupPassword, handleSignup }) => {
  ...
  return (
    <div className="signup-box">
      ...
      <div className="password-wrapper">
        ...
        <span className="password-icon" onClick={() => setShowSignupPassword(!showSignupPassword)}>
